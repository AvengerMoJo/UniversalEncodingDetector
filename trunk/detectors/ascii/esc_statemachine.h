...
#ifndef __ESC_STATEMACHINE_H__
#define __ESC_STATEMACHINE_H__

#include "../../lib/encoding_state_machine.h"

static u32 HZ_cls[ 256 / 8 ] = {
...
static const u32 HZCharLenTable[] = {0, 0, 0, 0, 0, 0};

static const SMModel HZ_SMModel = {
...
UED_STATE_MACHINE(HZ_ESM, &HZ_SMModel, NULL);

static u32 ISO2022CN_cls [ 256 / 8 ] = {
...
static const u32 ISO2022CNCharLenTable[] = {0, 0, 0, 0, 0, 0, 0, 0, 0};

static const SMModel ISO2022CN_SMModel = {
...
UED_STATE_MACHINE(ISO2022CN_ESM, &ISO2022CN_SMModel, NULL);

static u32 ISO2022JP_cls [ 256 / 8 ] = {
PCK4BITS(2,0,0,0,0,0,0,0),  // 00 - 07 
...
static const u32 ISO2022JPCharLenTable[] = {0, 0, 0, 0, 0, 0, 0, 0};

static const SMModel ISO2022JP_SMModel = {
...
UED_STATE_MACHINE(ISO2022JP_ESM, &ISO2022JP_SMModel, NULL);

static u32 ISO2022KR_cls [ 256 / 8 ] = {
PCK4BITS(2,0,0,0,0,0,0,0),  // 00 - 07 
PCK4BITS(0,0,0,0,0,0,0,0),  // 08 - 0f 
PCK4BITS(0,0,0,0,0,0,0,0),  // 10 - 17 
PCK4BITS(0,0,0,1,0,0,0,0),  // 18 - 1f 
...
static const u32 ISO2022KRCharLenTable[] = {0, 0, 0, 0, 0, 0};

static const SMModel ISO2022KR_SMModel = {
...
UED_STATE_MACHINE(ISO2022KR_ESM, &ISO2022KR_SMModel, NULL);
